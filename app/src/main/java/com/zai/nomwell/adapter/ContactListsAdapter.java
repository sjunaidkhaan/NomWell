 ...
 */
public class ContactListsAdapter extends BaseSwipeAdapter<MyListsHolder> {

    private ArrayList<MyListsData> myListData;
    private String swipeButtonText = "Delete";
    private OnRecyclerViewClickListener listener;

    public ContactListsAdapter(ArrayList<MyListsData> mySpotsData, String swipeButtonText, OnRecyclerViewClickListener listener) {
